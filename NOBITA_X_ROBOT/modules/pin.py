...
from NOBITA_X_ROBOT import Jaisingh
from NOBITA_X_ROBOT.modules.no_sql import AsuXdb as db
from NOBITA_X_ROBOT.utils.pluginhelp import member_permissions
...
@Jaisingh.on_message(filters.command("unpinall") & ~filters.private)
...
@Jaisingh.on_message(filters.command("antichannelpin") & ~filters.private)
...
@Jaisingh.on_message(filters.command("cleanlinked") & ~filters.private)
...
@Jaisingh.on_message(filters.command("permapin") & ~filters.private)
...
@Jaisingh.on_message(filters.linked_channel)
