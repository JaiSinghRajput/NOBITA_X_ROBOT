...
LOGGER = logging.getLogger("[𝓷𝓸𝓫𝓲𝓽𝓪]")
LOGGER.info("𝓷𝓸𝓫𝓲𝓽𝓪 ɪs sᴛᴀʀᴛɪɴɢ. | ᴀɴ Radhe_krishna_hare_hare ᴘʀᴏᴊᴇᴄᴛ ᴘᴀʀᴛs. | ʟɪᴄᴇɴsᴇᴅ ᴜɴᴅᴇʀ ɢᴘʟᴠ3.")
...
DRAGONS = get_user_list("eleusers.json", "sudos")  # DON'T EDIT
DEV_USERS = get_user_list("eleusers.json", "devs")  # . DON'T EDIT
DEMONS = get_user_list("eleusers.json", "supports")  # DON'T EDIT
WOLVES = get_user_list("eleusers.json", "whitelists")  # DON'T EDIT
TIGERS = get_user_list("eleusers.json", "tigers")  # DON'T EDIT
