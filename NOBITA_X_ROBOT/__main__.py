...
import NOBITA_X_ROBOT.modules.no_sql.users_db as sql
from NOBITA_X_ROBOT import BOT_USERNAME
from NOBITA_X_ROBOT import LOGGER as log
from NOBITA_X_ROBOT import OWNER_ID, OWNER_USERNAME, SUPPORT_CHAT, TOKEN
from NOBITA_X_ROBOT import Jaisingh as pbot
from NOBITA_X_ROBOT import StartTime, dispatcher, telethn, updater
...
def send_help(chat_id, text, keyboard=None):
    ...
    if not keyboard:
        ...
        # kb.append([InlineKeyboardButton(text='sᴜᴘᴘᴏʀᴛ', url='https://t.me/NOBITA_X_SUPPORT'),
...
@NOBITA_X_ROBOTcmd(command="text")
...
@NOBITA_X_ROBOTcallback(pattern=r"start_back")
@NOBITA_X_ROBOTcmd(command="start", pass_args=True)
...
@NOBITA_X_ROBOTcallback(pattern=r"help_")
def help_button(update: Update, context: CallbackContext):
    ...
    try:
        if mod_match:
            ...
            # kb.append([InlineKeyboardButton(text='Support', url='https://t.me/NOBITA_X_ROBOT'),
...
@NOBITA_X_ROBOTcmd(command="help")
...
@NOBITA_X_ROBOTcallback(pattern=r"stngs_")
...
@NOBITA_X_ROBOTcmd(command="settings")
...
@NOBITA_X_ROBOTmsg(Filters.status_update.migrate)
...
if __name__ == "__main__":
    log.info("[𝓷𝓸𝓫𝓲𝓽𝓪] →  sᴜᴄᴄᴇssғᴜʟʟʏ ʟᴏᴀᴅᴇᴅ ᴍᴏᴅᴜʟᴇs: " + str(ALL_MODULES))
